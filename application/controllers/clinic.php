...
class Clinic extends CI_Controller
{
    ...
    public function update_clinicinfo()
    {
        ...
        $data = array(
            ...
            "cif_timeopen" => $this->input->post('cif_timeopen'),
            "cif_keyword" => $this->input->post('cif_keyword'),
            "cif_name_en" => $this->input->post('cif_name_en'),
            "cif_service_en" => $this->input->post('cif_service_en'),
            "cif_address_en" => $this->input->post('cif_address_en'),
            "cif_subdistrict_en" => $this->input->post('cif_subdistrict_en'),
            "cif_district_en" => $this->input->post('cif_district_en'),
            "cif_province_en" => $this->input->post('cif_province_en'),
            "cif_postal_en" => $this->input->post('cif_postal_en')
        );
        $this->db->where('CLINICID', $this->input->post('CLINICID'));
        $this->db->update('tbclinicinfo', $data);
        
        $datas = array(
            "KEYWORD" => $this->input->post('cif_keyword'),
            "PROVINCE" => 'จ.'.$this->input->post('cif_province'),
        );
        $this->db->where('CLINICID', $this->input->post('CLINICID'));
        $this->db->update('tbclinic', $datas);
        redirect(base_url('dashboard/setting'));
    }
