...
<head>
    <title>Control Panel : Nutmor.com</title>
    ...
    <div id="particles-js"></div>
        <div class="d-flex justify-content-center h-100">
            <div class="card" style="border:2px solid #ccc">
                ...
                <br />
                <p style="text-align:center;font-size:14px; color:#11F738">
                        <i class="fa fa-lock"></i><span> เว็บไซต์นี้ได้เข้ารหัสแบบ SSL 256-bit ข้อมูลคุณจะรับการป้องกัน</span>
                    </p>
